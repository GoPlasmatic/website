...
with open('../nervous-system-compact.bin', 'wb') as f:
    # Header (30 bytes)
...
bin_size = os.path.getsize('../nervous-system-compact.bin')
orig_size = os.path.getsize('../nervous-system.bin') if os.path.exists('../nervous-system.bin') else 0
